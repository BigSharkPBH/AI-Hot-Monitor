const SOURCE_CONFIG = {
  ...
  v2ex:       { label: 'V2EX',   cls: 'badge-v2ex' },
  bilibili:   { label: 'B站',    cls: 'badge-bilibili' },
  weibo:      { label: '微博',    cls: 'badge-weibo' },
}
...
const SourceIcons = {
  ...
  v2ex: (
    <svg width="10" height="10" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
      <path d="M2 1a1 1 0 00-1 1v8a1 1 0 001 1h2v3l3-3h7a1 1 0 001-1V2a1 1 0 00-1-1H2z"/>
    </svg>
  ),
  bilibili: (
    <svg width="10" height="10" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
      <path d="M0 3a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2H2a2 2 0 01-2-2V3zm5.5 2a1 1 0 112 0 1 1 0 01-2 0zm4 0a1 1 0 112 0 1 1 0 01-2 0zM4 9h8v1H4V9z"/>
    </svg>
  ),
  weibo: (
    <svg width="10" height="10" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
